                ...
                <div className="container">
                    ...
                    <div className="row" id="phone-email">
                        <p className="col s12">
                            ...
                            <br></br>
                            <a href="mailto:nick@specialtycoaches.com">
                                nick@specialtycoaches.com
                            </a>
                        </p>
                    </div>
                    <div className="row" id="social-media">
                        <div className="col s12">
                            <ul id="social">
                                ...
                                <li>
                                    <a
                                        href="https://www.facebook.com/specialtycoaches/"
                                        className="social"
                                        id="social-fb"
                                        alt="Facebook"
                                        target="_blank"
                                ...
                                <li>
                                    <a
                                        href="https://www.instagram.com/specialtycoaches"
                                        className="social"
                                        id="social-ig"
                                        alt="Instagram"
                                        target="_blank"
                    ...
                    <div className="row copyright-row">
                        <div className="col s12">
                            <p id="copyright">
                                Copyright © 2019 Specialty Coaches, LLC. All
                                rights reserved.
                            </p>
                        </div>
                    </div>
